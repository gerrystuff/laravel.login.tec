...
switch (actualUrl) {
  case "/auth/registro":
    _main__WEBPACK_IMPORTED_MODULE_0__["default"].registroView();
    break;

  case "/auth/ingreso":
    _main__WEBPACK_IMPORTED_MODULE_0__["default"].ingresoView();
}
...
var Main = /*#__PURE__*/function () {
  function Main() {
    ...
    //Aux
    this.requestStatus = null; //Defaults
  ...
  _createClass(Main, [{
    ...
    value: function ingresoView() {
      ...
      this.ingresarBtn.addEventListener('click', function (event) {
        event.preventDefault();
